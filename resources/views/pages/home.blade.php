            ...
            <div class="mt-5 row gap">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="card-grow h-100">
                        <span class="badge-pricing">{{ $event->ticketCategories->first()->price ?? 'Free' }}</span>
                        <img src="{{ asset('assets/images/' . $event->image) }}" alt="semina" />
                        <div class="card-content">
                            ...
                            <div class="description">
                                {{ $event->location }}, {{ $event->date->format('d M Y') }}
                            </div>
